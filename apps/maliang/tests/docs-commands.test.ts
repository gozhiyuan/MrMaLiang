...
const OPERATOR_DOCS = [
  ...
  "packages/longwrite/skills/paper-workflow/SKILL.md",
  "docs/flagships/README.md",
  "docs/flagships/platform-adoption.md",
  ...
  "docs/flagships/nanochat-agentic-empirical-paper.md",
  ...
  "examples/flagships/nanochat-agentic-empirical-paper/README.md",

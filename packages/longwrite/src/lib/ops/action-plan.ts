...
const AcceptanceCriterion = z.object({
  ...
  metric: z.enum(["cited_sources", "cited_within_one_year_ratio", "accepted_cited_ratio", "cited_arxiv_only_ratio", "citations_per_page", "citation_depth_per_section", "taxonomy_cell_ab_sources", "comparative_tables", "verified_metadata_plots", "figures", "tables", "empirical_trials", "outline_readiness"]),
